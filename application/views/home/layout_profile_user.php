<html class="no-js wf-ffmetawebpro-n4-active wf-ffmetawebpro-i4-active wf-ffmetawebpro-n7-active wf-ffmetawebpro-i7-active wf-proximanova-n7-active wf-agencygothicctcondtt-n5-active wf-active">
   <!--<![endif]-->
   <head>
      <title><?php echo $this->session->userdata('full_name');?> | Thông tin tài khoản | SaigonFutsal.com</title>
      <meta charset="utf-8">
     <link rel="shortcut icon" href="<?php echo base_url();?>template/ezwebvietnam/home_sgfs/<?php echo $header['icon']?>" type="image/x-icon"/>
      ...
      <link href="<?php echo base_url();?>template/ezwebvietnam/home_sgfs/css/styles.css?v=1.10.3" media="all" rel="stylesheet" type="text/css">
	 ...
	 <script async="" type="text/javascript" src="https://www.googletagservices.com/tag/js/gpt.js"></script>
      ...
      <style type="text/css">.tk-ff-meta-web-pro{font-family:"ff-meta-web-pro",sans-serif;}.tk-proxima-nova{font-family:"proxima-nova",sans-serif;}.tk-agency-gothic-ct-condensed{font-family:"agency-gothic-ct-condensed",sans-serif;}.tk-agency-gothic-ct-cond-tt{font-family:"agency-gothic-ct-cond-tt",sans-serif;}</style>
      
      <script type="text/javascript">try{Typekit.load();}catch(e){}</script>
      <script async="" type="text/javascript" src="https://partner.googleadservices.com/gpt/pubads_impl_39.js"></script>
   ...
   <body style="zoom: 1;" data-twttr-rendered="true">
      ...
      <div id="wrapper" class="mobile-account">
         <form action="" method="post" name="edit_profile">
            <section class="my-account-section">
               <h1>Tài khoản</h1>
               <h2 class="sub-heading">Chi tiết</h2>
               <a class="edit-details" id="edit-details-btn" href="#">Thay đổi thông tin</a>
            </section>
            <?php echo $this->load->view($main_content);?>
            <section class="my-account-buttons" style="display: none;">
               <a href="#" id="cancel-btn" class="grey-btn">Cancel Changes</a>
               <input class="red-btn-submit" type="submit" value="Save Changes">
            </section>
         </form>
      </div>
      <script type="text/javascript">
      ...
      <script type="text/javascript">
         //<!--
            app.auth.baseDomain = "https://localhost";    //-->
      </script>
