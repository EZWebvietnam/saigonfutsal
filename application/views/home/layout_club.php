   ...
   <html class="ie ie8 no-js">
      ...
      <html class="ie ie9 no-js">
         ...
         <html class="no-js">
            <!--<![endif]-->
            <head>
               <title><?php echo $data_club[0]['name']?></title>
               <meta charset="utf-8">
               ...
               <meta name="description" content="<?php echo sub_string(loaibohtmltrongvanban($data_club[0]['about']),300)?>" >
               ...
               <script type="text/javascript">
                  //<!--
                     var googletag=googletag||{};googletag.cmd=googletag.cmd||[];(function(){var a=document.createElement("script");a.async=true;a.type="text/javascript";var b="https:"==document.location.protocol;a.src=(b?"https:":"http:")+"//www.googletagservices.com/tag/js/gpt.js";var c=document.getElementsByTagName("script")[0];c.parentNode.insertBefore(a,c)})()    //-->
               </script>
               <script type="text/javascript">
                  //<!--
            ...
            <?php 
                     ...
                     <div class="inner">
                        ...
                        <nav role="navigation">
                           <ul>
							  ...
							  <li><a class="active" href="<?php echo base_url();?>fust" id="megamenu-fust">FUST</a></li>
                           </ul>
                        </nav>
                        <!--//navigation -->	        
                        <div id="account">
               ...
               if(file_exists(PATH_FOLDER.ROT_DIR.'file/uploads/teams/'.$data_club[0]['cover']) && is_file(PATH_FOLDER.ROT_DIR.'file/uploads/teams/'.$data_club[0]['cover']) && $data_club[0]['cover']!='')
               {
               ?>
               	<style>
               		
               		div#sub-header, .cover_clubs
               		{
						background-image: url(<?php echo base_url();?>file/uploads/teams/<?php echo $data_club[0]['cover'] ?>);
					}
               	</style>
               <?php } else 
               {?>
               <style>
               		div#sub-header, .cover_clubs
               		{
						background-image: url(<?php echo base_url();?>file/uploads/no_image.gif);
					}
               	</style>
               <?php } ?>
...
"><?php echo $data_club[0]['name'];?></h1>
               ...
               <div id="wrapper" class="articles">
                  <div id="content">
                     <article>
                        <div class="slice link-list two">
                           <div class="portion">
                              <h2 ><a style="font-size: 28px !important;" href="/history/the-wenger-years" >Giới thiệu CLB</a></h2>
                              <p><?php echo sub_string(loaibohtmltrongvanban($data_club[0]['about']),200)?></p>
                              <ul>
                                 <li><a href="/history/the-wenger-years" >Đội hình</a></li>
                                 <li><a href="/history/the-wenger-years" >Cáp kèo thi đấu</a></li>	
                                 <li><a href="/history/the-wenger-years" >Gia nhập CLB</a></li>
                              </ul>
                           </div>
                           <!--/portion -->
                           <div class="portion">
                           ...
                           ?>
                              ...
                              <img width="324" height="182"  alt="<?php echo $data_club[0]['name'];?>" src="<?php echo base_url();?>file/uploads/teams/<?php echo $data_club[0]['logo']?>">
                              <?php } else {?>
                              <img width="324" height="182"  alt="<?php echo $data_club[0]['name']?>" src="<?php echo base_url();?>file/uploads/no_image.gif">
                             <?php } ?>
                           </div>
                           <!--/portion -->
                        </div>
    ...
    <p><?php echo $data_club[0]['name']?><br>Highbury House<br>75 Drayton Park<br>London<br>N5 1BU</p>
<p>Switchboard<br>020 7619 5003</p>
<p>Box office<br><a href="mailto:boxoffice@arsenal.co.uk" target="_blank">boxoffice@arsenal.co.uk</a></p>
</div><!--/widget -->            <div id="div-gpt-ad-1353671982241-5" class="large-only ad-small" style="width:170px; height:237px;" data-attr-pushdown="0"><div id="google_ads_iframe_/16242290/arsenal_web_ros_small_0__container__" style="border: 0pt none;"><iframe id="google_ads_iframe_/16242290/arsenal_web_ros_small_0" name="google_ads_iframe_/16242290/arsenal_web_ros_small_0" width="170" height="237" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" src="javascript:&quot;<html><body style='background:transparent'></body></html>&quot;" __idm_frm__="28" style="border: 0px; vertical-align: bottom;"></iframe></div><iframe id="google_ads_iframe_/16242290/arsenal_web_ros_small_0__hidden__" name="google_ads_iframe_/16242290/arsenal_web_ros_small_0__hidden__" width="0" height="0" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" src="javascript:&quot;<html><body style='background:transparent'></body></html>&quot;" __idm_frm__="28" style="border: 0px; vertical-align: bottom; visibility: hidden; display: none;"></iframe></div>            <div id="div-gpt-ad-1353671982241-6" class="large-only ad-tall" style="width:170px; height:530px;" data-attr-pushdown="0"><div id="google_ads_iframe_/16242290/arsenal_web_ros_tall_0__container__" style="border: 0pt none;"><iframe id="google_ads_iframe_/16242290/arsenal_web_ros_tall_0" name="google_ads_iframe_/16242290/arsenal_web_ros_tall_0" width="170" height="530" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" src="javascript:&quot;<html><body style='background:transparent'></body></html>&quot;" __idm_frm__="28" style="border: 0px; vertical-align: bottom;"></iframe></div><iframe id="google_ads_iframe_/16242290/arsenal_web_ros_tall_0__hidden__" name="google_ads_iframe_/16242290/arsenal_web_ros_tall_0__hidden__" width="0" height="0" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" src="javascript:&quot;<html><body style='background:transparent'></body></html>&quot;" __idm_frm__="27" style="border: 0px; vertical-align: bottom; visibility: hidden; display: none;"></iframe></div>            
        </div>
                     <div class="widgets">
                     ...
                     <div id="dm-benefits">
                        <div class="dm-both">
                           <div class="benefits-wrapper" >
                              <ul>
                                 <li>Monthly Membership E-Newsletter</li>
                              ...
                              <div class="sign-up-row">
                                 <a href="javascript:void(0);" class="btn red-btn bind-register">&lt; Sign up for FREE</a>
                              </div>
                           </div>
                        </div>
                        <!--/dm-both -->
               ...
               <!-- 11-05-2014 08:50:25 :: evl3301254 -->
            </body>
         </html>
