      ...
      <html class="ie ie9 no-js">
         ...
         <html class="no-js">
            ...
            <body >
               ...
               <div id='wrapper' class="medium-margin-fix">
                  ...
                  {
                  ?>
                     <section class="team-news-section " id='injury<?php echo $list_new['id_new']?>'>
                     	<?php 
                     		if(file_exists(PATH_FOLDER.ROT_DIR.'file/uploads/news/'.$list_new['image']) && is_file(PATH_FOLDER.ROT_DIR.'file/uploads/news/'.$list_new['image']) && $list_new['image']!='')
                     		{
                     	?>
                        <img width="96" height="115" src="<?php echo base_url();?>file/uploads/news/<?php echo $list_new['image']?>" />
                        <?php } else { ?>
                        <img width="96" height="115" src="<?php echo base_url();?>file/uploads/no_image.gif" />
                        <?php } ?>
                        <h2><a href="<?php echo base_url();?>tin-tuc/<?php echo $list_new['id_catenew']?>-<?php echo mb_strtolower(url_title(removesign($list_new['title_cate'])))?>/p<?php echo $list_new['id_new'] ?>-<?php echo mb_strtolower(url_title(removesign($list_new['title_new'])))?>"><?php echo $list_new['title_new']?></a></h2>
                        <p class="last-updated">Last Updated: May 01</p>
                        <p>
                        <p><?php echo sub_string(loaibohtmltrongvanban($list_new['content']),300);?></p>
                        </p>
                        <p>
                           <a href="<?php echo base_url();?>tin-tuc/<?php echo $list_new['id_catenew']?>-<?php echo mb_strtolower(url_title(removesign($list_new['title_cate'])))?>/p<?php echo $list_new['id_new'] ?>-<?php echo mb_strtolower(url_title(removesign($list_new['title_new'])))?>" class="red-arrow-link">Đọc thêm</a>                    
                        </p>
                     </section>
                     <?php } ?>
                     <?php  } else { ?>
                     <section class="team-news-section " id='injury333'>
                     </section>
                     <?php } ?>
                  ...
                  <aside class='sidebar news-sidebar'>
                     <div class='widgets'>
                        ...
                        <h2>Features</h2>
                        <div class='widget'>
                           <a href="/news/features/20140506/the-right-combination" class="feature">
                              <img  alt="Eye for Detail - The Right Combination" src="/assets/_files/scaled/192x280/may_14/gun__1399377091_thumb_eye_combination.jpg">	
                              <div class="overlay"></div>
                              <div class="reveal">
                                 <p>Tactical expert Michael Cox examines Arsenal's finest team goals and Olivier Giroud's effect on the Gunners' attacking style</p>
                              </div>
                              <h4>Eye for Detail:<span>The Right Combination </span></h4>
                           </a>
                           <!--/feature -->        
                        </div>
                        <!--/widget-->
                        <div class='widget'>
                           <a href="/news/features/20140507/home-runs" class="feature">
                              <img  alt="Behind the Numbers" src="/assets/_files/scaled/192x280/may_14/gun__1399461164_thumb_behindthenumbers_atemira.jpg">	
                              <div class="overlay"></div>
                              <div class="reveal">
                                 <p>This week our statistican analyses Arsenal's record at Emirates Stadium in 2013/14</p>
                              </div>
                              <h4>Behind The Numbers:<span>Home runs </span></h4>
                           </a>
                           <!--/feature -->        
                        </div>
                        <!--/widget-->
               ...
               <!-- 07-05-2014 16:37:00 :: eul3300036 -->
            </body>
         </html>
